...
Pour cela, nous avons utilisé un jeu de données trouvé sur Kaggle datant de 2017. 
...
À noter que ce sont justement les diamants de faible carat qui sont les plus présents dans le jeu de données.
...
**Courbe (*line plot*) :**
Nous avons utilisé un *line plot* pour étudier la relation entrele le carat et le prix moyen. Il nous a permit de visualiser l'évolution du prix moyen en fonction du poids du diamant, et de mettre en lumière la forte corrélation entre le prix et le carat.
...
Ce manque de données justifie probablement le résultat inatendu observé sur le graphique précédent.
...
Cependant, cette relation ne suffit à elle seule à expliquer les écarts de prix, notamment pour les diamants les plus cher.
